...
#roads-text-ref-low-zoom {
  ...
  [highway = 'trunk'][zoom >= 11][zoom < 13][width < 9] {
    shield-name: "[refs]";
    shield-size: 10;
    shield-fill: #000;
    shield-placement: line;
  ...
  [highway = 'primary'][zoom >= 11][zoom < 13][width < 9] {
    shield-name: "[refs]";
    shield-size: 10;
    shield-fill: #000;
    shield-placement: line;
  ...
  [highway = 'secondary'][zoom >= 12][zoom < 13][width < 9] {
    shield-name: "[refs]";
    shield-size: 10;
    shield-fill: #000;
    shield-placement: line;
...
#roads-text-ref {
  ...
  [highway = 'primary'][zoom >= 13][width < 9] {
    shield-name: "[refs]";
    shield-size: 10;
    shield-fill: #000;
    shield-placement: line;
  ...
  [highway = 'secondary'][bridge = 'no'][zoom >= 13][width < 9] {
    shield-name: "[refs]";
    shield-size: 10;
    shield-fill: #000;
    shield-placement: line;
  ...
  [highway = 'tertiary'][bridge = 'no'][zoom >= 13][width < 9] {
    shield-name: "[refs]";
    shield-size: 10;
    shield-fill: #000;
    shield-placement: line;
